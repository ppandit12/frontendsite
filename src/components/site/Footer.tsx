      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-white/70">
            ...
            <li><Link to="/areas-we-serve" className="hover:text-white">Areas We Serve</Link></li>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-white/70">
            ...
            <li className="flex items-center gap-2"><MapPin size={14} /> Serving Toronto, Etobicoke & Mississauga</li>
