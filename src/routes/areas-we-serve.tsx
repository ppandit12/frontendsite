...
function AreasPage() {
  const { content } = useContent("areas-we-serve");

  const heroContent = content?.hero || {
    tagline: 'Local Experts',
    headline: 'Areas We Serve',
    subtitle: 'Providing professional stump grinding and yard restoration across the Greater Toronto Area and beyond. Find your neighborhood below.',
  };
  ...
  const listContent = content?.list || {
    ...
    ctaText: "Don't see your neighborhood? We primarily focus on Toronto, Etobicoke, and Mississauga to ensure prompt service. For large-scale projects north of the 401, please contact us for a custom quote."
  };
      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            >
              <span className="inline-flex items-center gap-2 text-xs font-bold tracking-[0.25em] text-[var(--brown)] uppercase mb-6">
                <MapPin size={14} /> {heroContent.tagline}
              </span>
        ...
        <section className="py-24 bg-background">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {listContent.areas.map((area: any, i: number) => (
        ...
        <section className="py-24 bg-charcoal text-white relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            <Reveal>
              <h2 className="text-4xl sm:text-6xl uppercase font-display mb-8">{listContent.ctaHeadline || 'Not on the list?'}</h2>
              <p className="text-xl text-white/60 mb-12 italic">
                {listContent.ctaText}
              </p>

              <div className="flex flex-wrap justify-center gap-4">
                <a href="https://clienthub.getjobber.com/hubs/e26093ba-9938-4ec5-b46f-0e1ed9977087/public/requests/4622022/new" className="btn-primary">Request a Quote <ArrowRight size={18} /></a>
